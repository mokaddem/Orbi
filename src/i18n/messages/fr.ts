...
const fr: typeof en = {
  ...
  duel: {
    ...
    shareTextAnon: 'Tu es défié·e en duel sur Orbi !',
    resultShareText: '{name} a relevé ton duel Orbi — vois qui a gagné !',
    resultShareTextAnon: 'Ton duel Orbi a été relevé — vois qui a gagné !',
