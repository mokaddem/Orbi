...
const de: typeof en = {
  ...
  duel: {
    ...
    shareTextAnon: 'Du wurdest zu einem Orbi-Duell herausgefordert!',
    resultShareText: '{name} hat dein Orbi-Duell angenommen — sieh, wer gewonnen hat!',
    resultShareTextAnon: 'Dein Orbi-Duell wurde angenommen — sieh, wer gewonnen hat!',
    ...
    save: 'Speichern',
    cancel: 'Abbrechen',
    settingsTitle: 'Duelle',
    settingsLabel: 'Duell-Name',
