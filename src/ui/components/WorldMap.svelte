<script lang="ts">
  ...
  const HIGHLIGHT_FILL = 0.4; // fraction of the board the auto-zoomed highlight should fill (a bit
  // of surrounding context — deliberately not too tight when picking the highlighted country)
